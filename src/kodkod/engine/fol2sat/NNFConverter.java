...
public class NNFConverter extends AbstractReplacer {
     ...
     * @see kodkod.ast.visitor.AbstractVoidVisitor#visit(NotFormula)
     */
     ...
     * @see kodkod.ast.visitor.AbstractVoidVisitor#visit(BinaryFormula)
     */
     ...
     * Visits the formula's children with appropriate settings
     * for the negated flag if bf  has not been visited before.
     * @see kodkod.ast.visitor.AbstractVoidVisitor#visit(NaryFormula)
     */
