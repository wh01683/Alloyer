...
public class TestDomain {
    ...
    /* Helper methods to simplify using the API for this example. */
        ...
        Sig.PrimSig makeSig(String name, boolean isAbstract, boolean isOne) throws Err {
            Sig.PrimSig ans = new Sig.PrimSig(name, (isAbstract ? Attr.ABSTRACT : null), (isOne ? Attr.ONE : null));
            sigs.add(ans);
            return ans;
        }

        Sig.PrimSig makeSig(Sig.PrimSig parent, String name, boolean isAbstract, boolean isOne) throws Err {
            Sig.PrimSig ans = new Sig.PrimSig(name, parent, (isAbstract ? Attr.ABSTRACT : null), (isOne ? Attr.ONE : null));
            sigs.add(ans);
            return ans;
        }
    ...
    /* Here is instance number 1. */
        ...
        void makeInstance1() throws Err {
            ...
            // D2.parent = D1
            // D1.parent = Root
            Sig.PrimSig file1 = makeSig(file, "F1", false, true);
            Sig.PrimSig file2 = makeSig(file, "F2", false, true);
            Sig.PrimSig file3 = makeSig(file, "F3", false, true);
            Sig.PrimSig dir1 = makeSig(dir, "D1", false, true);
            Sig.PrimSig dir2 = makeSig(dir, "D2", false, true);
